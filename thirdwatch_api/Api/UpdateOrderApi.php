...
class UpdateOrderApi
{
     ...
     *
     * @param \ai.thirdwatch\Model\UpdateOrder $jSON Update details of an existing order. Only &#x60;_userID&#x60; is required field. But this should contain existing order info. (required)
